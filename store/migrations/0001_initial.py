# Generated by Django 5.1.5 on 2025-03-02 23:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'รอดำเนินการ'), ('completed', 'สั่งซื้อสำเร็จ'), ('rejected', 'ถูกปฏิเสธ')], default='pending', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.CharField(choices=[('electronics', 'อิเล็กทรอนิกส์'), ('clothing', 'เสื้อผ้า'), ('accessories', 'อุปกรณ์เสริม'), ('home_appliances', 'เครื่องใช้ไฟฟ้าภายในบ้าน'), ('books', 'หนังสือ'), ('others', 'อื่นๆ')], default='others', max_length=100)),
